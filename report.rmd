...
header-includes:
    ...
    \definecolor{uniwagreen}{RGB}{27, 176, 30}
...
\newcommand{\lstbfont}[1]{\color{#1}\footnotesize\bfseries}
...
Δεν μπορούμε να διακρίνουμε κανένα αποτέλεσμα. Αυτό ίσως είναι όπως θα περιμέναμε γιατί 
η διαφορά θα περιμέναμε να βρίσκεται στην μνήμη που χρειαζόμαστε.
